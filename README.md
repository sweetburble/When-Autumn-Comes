...
<br/>
2-5. 정해진 위치에 잘 저장하셨다면 **kakao_token.py**를 실행해주세요. 
<br/>자동으로 access_token을 받아와 주고, 계속 쓸 수 있도록 **kakao_token.json**파일도 생성해줍니다.  
...
```
3-4. 여러분의 구글 클라우드 서비스 계정 키가 위치한 경로를 잘 숙지하시고 아래 명령어를 입력해주세요. <br/>
키가 담긴 json 파일을 우클릭 한다음 **경로로 복사**를 하면 편합니다. 
```
...
### "코딩" "게임" "가을" "우울" "심심" "시티팝" "비 오는 날" "추천"에 맞춰서 말해보세요!<br/>
